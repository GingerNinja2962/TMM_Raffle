...
import org.example.core.db.entities.impl.UserEntity;
...
public class UserConverter implements Converter<UserEntity, User> {
    ...
    public User convertFromEntity(@NonNull UserEntity entity) {
        ...
        User user = new UserImpl(entity.getId(), entity.getName(), entity.getValue());
    ...
    private boolean hasNullValues(UserEntity entity, String methodName) {
        return checkNull(entity.getId() == null, entity.getName() == null, entity.getValue() == null, methodName);
    }
    ...
    private boolean checkNull(boolean id, boolean name, boolean value, String methodName) {
